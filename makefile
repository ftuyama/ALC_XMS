...
main: main.o Classes/GenKiss2/GenKiss2.o Classes/GenDG/GenDG.o Classes/GenFunc/GenFunc.o Classes/GenVHDL/GenVHDL.o Classes/tools/tools.o
	gcc -std=c99 -Wall main.o Classes/GenKiss2/GenKiss2.o Classes/GenDG/GenDG.o  Classes/GenFunc/GenFunc.o Classes/GenVHDL/GenVHDL.o Classes/tools/tools.o -o main
